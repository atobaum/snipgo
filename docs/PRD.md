...
is\_favorite: true                            \# 즐겨찾기 여부 (Boolean)  
created\_at: 2025-12-20T10:00:00Z             \# 생성 일시 (불변)  
updated\_at: 2025-12-25T14:30:00Z             \# 수정 일시 (저장 시 갱신)  
\---
...
* **GUI:** 태그 입력 UI 개선 (Chips 형태), is\_favorite 필터링 및 정렬.
